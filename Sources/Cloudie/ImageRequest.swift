...
public struct ImageRequest: CustomStringConvertible, Sendable, ExpressibleByStringLiteral {
    ...
    public struct UserInfoKey: Hashable, ExpressibleByStringLiteral, Sendable {
        ...
        /// )
        /// ```
        public static let imageIdKey: ImageRequest.UserInfoKey = "github.com/llarrynguyen/cloudie/imageId"

        /// The image scale to be used. By default, the scale matches the scale
        /// of the current display.
        public static let scaleKey: ImageRequest.UserInfoKey = "github.com/llarrynguyen/cloudie/scale"
        ...
        public static let thumbnailKey: ImageRequest.UserInfoKey = "github.com/llarrynguyen/cloudie/thumbnail"
    }
    ...
    public struct ThumbnailOptions: Hashable, Sendable {
        ...
        public func makeThumbnail(with data: Data) -> PlatformImage? {
            Cloudie.makeThumbnail(data: data, options: self)
        }

        var identifier: String {
            "com.github/llarynguyen/cloudie/thumbnail?\(targetSize.parameters),options=\(createThumbnailFromImageIfAbsent)\(createThumbnailFromImageAlways)\(createThumbnailWithTransform)\(shouldCacheImmediately)"
        }
    }
...
extension ImageRequest {
    ...
    private final class Container: @unchecked Sendable {
        ...
        // After trimming the request size in Cloudie 10, CoW it is no longer as
