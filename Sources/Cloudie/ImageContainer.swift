...
public struct ImageContainer: @unchecked Sendable {
    ...
    public struct UserInfoKey: Hashable, ExpressibleByStringLiteral, Sendable {
        ...
        static let isThumbnailKey: UserInfoKey = "com.github/llarynguyen/cloudie/skip-decompression"

        /// A user info key to get the scan number (Int).
        public static let scanNumberKey: UserInfoKey = "com.github/llarynguyen/cloudie/scan-number"
    }
